...
const u32 gTrainerFrontPic_Maito[] = INCBIN_U32("graphics/trainers/front_pics/maito.4bpp.lz");
const u16 gTrainerPalette_Maito[] = INCBIN_U16("graphics/trainers/front_pics/maito.gbapal");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_MAITO, gTrainerFrontPic_Maito, gTrainerPalette_Maito),
};
