...
#define PIDGEOT_SPEED (P_UPDATED_STATS >= GEN_6 ? 101 : 91)
    ...
    [SPECIES_SPEAROW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_KEEN_EYE, ABILITY_SNIPER, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BROWN,
...
#define RAICHU_SPEED (P_UPDATED_STATS >= GEN_6 ? 110 : 100)
    ...
    [SPECIES_SANDSLASH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SAND_FORCE, ABILITY_TOUGH_CLAWS, ABILITY_NONE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_CLEFABLE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_LUNAR_ENERGY, ABILITY_MAGIC_GUARD, ABILITY_NONE },
    #else
    ...
    [SPECIES_VULPIX] =
    {
        ...
        .baseDefense   = 40,
        .baseSpeed     = 75,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 50 : 75,
        .baseSpDefense = 75,
        .types = MON_TYPES(TYPE_FIRE),
        .catchRate = 190,
    ...
    [SPECIES_NINETALES] =
    {
        ...
        .baseDefense   = 75,
        .baseSpeed     = 105,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 81 : 105,
        .baseSpDefense = 125,
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PRESSURE, ABILITY_DROUGHT, ABILITY_NONE },
        .bodyColor = BODY_COLOR_YELLOW,
...
#define ALAKAZAM_SP_DEF 135
    ...
    [SPECIES_TENTACOOL] =
    {
        ...
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_STATIC, ABILITY_RAIN_DISH },
        .bodyColor = BODY_COLOR_BLUE,
...
#define FARFETCHD_ATTACK (P_UPDATED_STATS >= GEN_7 ? 90 : 65)
    ...
    [SPECIES_GRIMER] =
    {
        ...
        .abilities = { ABILITY_POISON_TOUCH, ABILITY_STICKY_HOLD, ABILITY_NONE },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_GRIMER_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_POWER_OF_ALCHEMY, ABILITY_GLUTTONY, ABILITY_NONE },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Grimer"),
        .cryId = CRY_GRIMER,
        .natDexNum = NATIONAL_DEX_GRIMER,
...
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE}
    ...
    [SPECIES_GYARADOS] =
    {
        ...
        .baseSpDefense = 100,
        .types = MON_TYPES(TYPE_WATER, TYPE_DRAGOM),
        .catchRate = 45,
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_LEVITATE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_EEVEE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_FLUFFY, ABILITY_ADAPTABILITY, ABILITY_ANTICIPATION },
    #else
    ...
    [SPECIES_JOLTEON] =
    {
        ...
        .baseSpeed     = 130,
        .baseSpAttack  = 100,
        .baseSpDefense = P_UPDATED_STATS >= GEN_2 ? 65 : 110,
        .types = MON_TYPES(TYPE_ELECTRIC),
        .catchRate = 45,
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_VOLT_ABSORB, ABILITY_SKILL_LINK, ABILITY_NONE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_FLAREON] =
    {
        ...
        .baseDefense   = 60,
        .baseSpeed     = 95,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 65 : 110,
        .baseSpDefense = 110,
        .types = MON_TYPES(TYPE_FIRE),
        .catchRate = 45,
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FLUFFY, ABILITY_FLASH_FIRE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_RED,
